 ...
 */
  ...
  console.log(randomInteger(0, 10)); // Generates a random integer between 0 and 10
console.log(randomInteger(10, 200)); // Generates a random integer between 10 and 200
...
// Test cases
console.log(setDelay("easy"));    // Returns 1500
console.log(setDelay("normal"));  // Returns 1000
console.log(setDelay("hard"));    // Returns a random number between 600 and 1200
